...
int main() {
    ...
    char ma_lettre = 'A';
    unsigned char ma_lettre = 'B';
    int mon_nombreint = 50;
    unsigned int mon_nombreint = 50;
    short mon_nombreshort = -10;
    unsigned short mon_nombreshort = -10;
    long int mon_nombrelongint = 200000000;
    unsigned long int mon_nombrelongint = 80000000;
    long long int mon_nombrelonglong = 9999999999999999;
    unsigned long long int mon_nombrelonglong = 77777777777777777;
